...
export class CreateAppointmentsTable1728819772990
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."atendimentos_status_enum" AS ENUM('AGENDADA', 'EM_ANDAMENTO', 'CONCLUÍDA', 'CANCELADA')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "atendimentos" ADD "horario" TIME NOT NULL`,
    );
  }
